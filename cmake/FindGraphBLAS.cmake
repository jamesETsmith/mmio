...
string(REGEX MATCH "[0-9]+.[0-9]+.[0-9]+" GRAPHBLAS_VERSION
             ${GRAPHBLAS_FILENAME})
...
if(EXISTS "${GRAPHBLAS_INCLUDE_DIR}" AND NOT GRAPHBLAS_VERSION)
  ...
  set(GRAPHBLAS_VERSION
      "${GRAPHBLAS_MAJOR}.${GRAPHBLAS_MINOR}.${GRAPHBLAS_PATCH}")
endif()
...
mark_as_advanced(GRAPHBLAS_INCLUDE_DIR GRAPHBLAS_LIBRARY GRAPHBLAS_STATIC
                 GRAPHBLAS_LIBRARIES)
